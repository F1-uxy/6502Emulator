...
set( tests_TESTS [==[Memory Initialisation]==] [==[CPU Register Reset]==] [==[LDA_IM Load value into ACC Immediate]==] [==[LDA_ZP can Load Value into Acc]==] [==[LDA_ZP_X can Load Value into Acc with offset X]==] [==[LDA_ABS can Load ]==] [==[LDA_ABS_X can Load address offset by x]==] [==[INS_JMP_ABS can change PC]==])
